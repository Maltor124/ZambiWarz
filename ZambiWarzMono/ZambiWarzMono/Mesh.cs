...
namespace ZambiWarzMono
{
    class Mesh
    {
        ...
        public Mesh(List<Vector2> vertices, List<Triad> triads)
        {
            ...
            this.vertices = new QuadTree(0, 0, 800, 600);
        ...
        {
            return vertices.FindNearest(point);
        }
        ...
        {
            get { return vertices.QueryRange(vertices.bounds).AsReadOnly(); }
        }
